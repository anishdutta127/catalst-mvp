...
export const lines = {
  ...
  s01: {
    cedric: {
      ...
      welcome1: (name: string) => `${name}. The garden recognized you before you typed your name.`,
      welcome2: 'What you\'re about to do \ . most people spend years circling it. We\'re going to cut through that noise in a few minutes. I\'ll read your instincts. You just react.',
      pathA: {
